...
const bPepperCrypted = bcrypt.hashSync(passParam + pepper, 10);
console.log(bPepperCrypted);

const isAuthenticated = bcrypt.compareSync(passParam + pepper, users[userParam].bcryptPeppered);
if (isAuthenticated) {
