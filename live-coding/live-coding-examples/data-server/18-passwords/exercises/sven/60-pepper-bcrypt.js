...
// const pepperParam = passParam + pepper;
// const newBcrypt = bcrypt.hashSync(passParam, SALT_ROUNDS);
// console.log("newBcrypt", newBcrypt);

//process.exit();

const pepperedPass = passParam + pepper;
//console.log("pepperedPass:", pepperedPass);

const SALT_ROUNDS = 12;
//const pepperedBcrypt = bcrypt.hashSync(pepperedPass, SALT_ROUNDS);
//console.log("bcryptPeppered:", pepperedBcrypt)

const isAuthenticated = bcrypt.compareSync(pepperedPass, users[userParam].bcryptPeppered);
if (isAuthenticated) {
