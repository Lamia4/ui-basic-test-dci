...
const schema = {
    ...
    items: {
        type: "object",
        additionalProperties: false, // Setzen wir diesen Wert auf false, dürfen keine weiteren Properties vorhanden sein als die, die hier im Schema beschrieben werden
        required: ["id", "title", "userName"], // Ist mindestens eine als "required" gelistete Property nicht vorhanden, führt das zu einem Fehler
        properties: {
            id: {
                type: "string",
                minLength: 8,
