...
ajvFormats(ajv);
//ajv.addFormat("number16", /[0-9a-f]+/i);
...
const schema = {
    ...
    items: {
        ...
        required: ["id", "title", "userName", "dateCreated", "hex", "rgb", "hsv"], // Ist mindestens eine als "required" gelistete Property nicht vorhanden, führt das zu einem Fehler
        properties: {
            id: {
                type: "number",
            },
