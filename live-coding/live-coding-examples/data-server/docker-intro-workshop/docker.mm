...
<node TEXT="Docker" FOLDED="false" ID="ID_751611297" CREATED="1616062291930" MODIFIED="1625053145197" STYLE="oval">
<font SIZE="18"/>
...
<node TEXT="EXPOSE" ID="ID_1284862435" CREATED="1616062334907" MODIFIED="1625053211474"><richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <p>
      kann wegfallen, stattdessen im docker-compose.yml Ports weiterleiten.
    </p>
  </body>
</html>
...
<node TEXT="CMD" ID="ID_1945910893" CREATED="1616062342779" MODIFIED="1625053285878"><richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <p>
      kann wegfallen, stattdessen im docker-compose.yml &quot;command&quot; nutzen, um das festzulegen.
    </p>
  </body>
</html>
...
<node TEXT="Image" POSITION="right" ID="ID_1751301122" CREATED="1616062400515" MODIFIED="1625053657280" LINK="https://www.computerweekly.com/de/definition/Docker-Image" HGAP_QUANTITY="153.49999584257614 pt" VSHIFT_QUANTITY="65.99999803304677 pt">
...
<node TEXT="docker - commandline-tool" FOLDED="true" POSITION="right" ID="ID_303279578" CREATED="1616069949728" MODIFIED="1616069958635">
<edge COLOR="#00007c"/>
...
<node TEXT="docker-compose" FOLDED="true" POSITION="right" ID="ID_519596273" CREATED="1625048283389" MODIFIED="1625048289507">
<edge COLOR="#007c00"/>
<node TEXT="docker-compose.yml" ID="ID_1952935714" CREATED="1625048291500" MODIFIED="1625053628234" LINK="https://docs.docker.com/compose/compose-file/"><richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <p>
      The file docker-compose.yml definines services. For each service what image to use and/or how to build that image. And the runtime-environment of that service, which includes:
    </p>
    <p>
      - command
    </p>
...
<node TEXT="UP" ID="ID_531338225" CREATED="1625048297810" MODIFIED="1625048301582"/>
<node TEXT="START" ID="ID_1248686281" CREATED="1625048311530" MODIFIED="1625048316233"/>
<node TEXT="STOP" ID="ID_314922880" CREATED="1625048316674" MODIFIED="1625048318539"/>
<node TEXT="DOWN" ID="ID_112107045" CREATED="1625048302250" MODIFIED="1625048304466"/>
<node TEXT="LOGS" ID="ID_48263300" CREATED="1625048320338" MODIFIED="1625048322048"/>
</node>
</node>
</map>
