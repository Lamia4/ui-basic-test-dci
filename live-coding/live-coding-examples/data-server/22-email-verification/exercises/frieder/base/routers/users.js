...
import verificationEmail from '../middlewares/verificationEmail.js'

const router = express.Router();

// User
router.post("/", csrfProtection, usersController.create, verificationEmail.sendVerificationEmail);
